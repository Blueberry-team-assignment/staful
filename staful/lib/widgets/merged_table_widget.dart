...
class MergedTableWidget extends StatefulWidget {
  /// Creates a screen that shows a color palette in the TableView widget.
  const MergedTableWidget({super.key});

  @override
  State<MergedTableWidget> createState() => _MergedTableWidgetState();
}

class _MergedTableWidgetState extends State<MergedTableWidget> {
  final List<int> _numbers = List.generate(25, (index) => index);
